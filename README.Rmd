...
ligand_importances_discrete = bind_rows(lapply(settings_ligand_pred, get_single_ligand_importances, igand_target_matrix[,all_ligands] %>% make_discrete_ligand_target_matrix()))
