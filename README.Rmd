...
ligand_importances = get_single_ligand_importances(settings_ligand_pred,ligand_target_matrix[,all_ligands])
ligand_importances_discrete = get_single_ligand_importances(settings_ligand_pred,ligand_target_matrix[,all_ligands] %>% make_discrete_ligand_target_matrix())
...
ligand_importances_glm = get_multi_ligand_importances(settings_ligand_pred,ligand_target_matrix[,all_ligands],algorithm = "glm",filter_genes = TRUE) %>% rename(glm_imp = importance)
