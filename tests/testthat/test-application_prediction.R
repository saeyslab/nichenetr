...
test_that("Seurat wrapper works", {
  ...
  lfc_output = get_lfc_celltype(seurat_obj = seurat_object_lite, celltype_oi = "CD8 T", condition_colname = "aggregate", condition_oi = "LCMV", condition_reference = "SS", min.pct = 0.10)
