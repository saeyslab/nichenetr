...
test_that("Objective function to construct and evaluate the model for parameter optimization is ok", {
  ...
  test_evaluation_optimization = model_evaluation_optimization_mlrmbo(test_input, source_weights_df$source %>% unique(), "PPR", TRUE, lr_network_human, signaling_network_human, gr_network_human, lapply(expression_settings_validation[1:5],convert_expression_settings_evaluation), secondary_targets = FALSE, remove_direct_links = "no")
  ...
  test_evaluation_optimization = model_evaluation_optimization_mlrmbo(test_input, source_weights_df$source %>% unique(), "PPR", FALSE, lr_network_human, signaling_network_human, gr_network_human, lapply(expression_settings_validation[1:5],convert_expression_settings_evaluation), secondary_targets = FALSE, remove_direct_links = "no")
  ...
  test_evaluation_optimization = model_evaluation_optimization_mlrmbo(test_input, source_weights_df$source %>% unique(), "direct", FALSE, lr_network_human, signaling_network_human, gr_network_human, lapply(expression_settings_validation[1:5],convert_expression_settings_evaluation), secondary_targets = FALSE, remove_direct_links = "no")
  ...
  test_evaluation_optimization = model_evaluation_optimization_mlrmbo(test_input, source_weights_df$source %>% unique(), "SPL", FALSE, lr_network_human, signaling_network_human, gr_network_human, lapply(expression_settings_validation[1:5],convert_expression_settings_evaluation), secondary_targets = FALSE, remove_direct_links = "no")
  ...
  test_input = list("source_weights" = rep(0.5, times = nr_datasources), "lr_sig_hub" = 0.5, "gr_hub" = 0.5)
  test_evaluation_optimization = model_evaluation_optimization_mlrmbo(test_input, source_weights_df$source %>% unique(), "PPR", FALSE, lr_network_human, signaling_network_human, gr_network_human, lapply(expression_settings_validation[1:5],convert_expression_settings_evaluation), secondary_targets = FALSE, remove_direct_links = "no", damping_factor = 0)
  ...
  test_evaluation_optimization = model_evaluation_hyperparameter_optimization_mlrmbo(test_input, source_weights, "PPR", TRUE, lr_network_human, signaling_network_human, gr_network_human, lapply(expression_settings_validation[1:5],convert_expression_settings_evaluation), secondary_targets = FALSE, remove_direct_links = "no")
  expect_type(test_evaluation_optimization, "double")
  expect_equal(length(test_evaluation_optimization),4)

  nr_datasources = source_weights_df$source %>% unique() %>% length()
  test_input = list("source_weights" = rep(0.5, times = nr_datasources), "lr_sig_hub" = 0.5, "gr_hub" = 0.5, "damping_factor" = 0.5)
  test_evaluation_optimization = model_evaluation_optimization_application(test_input, source_weights_df$source %>% unique(), algorithm = "PPR", TRUE, lr_network_human, signaling_network_human, gr_network_human, list(convert_expression_settings_evaluation(expression_settings_validation$TGFB_IL6_timeseries)), secondary_targets = FALSE, remove_direct_links = "no", classification_algorithm = "lda", var_imps = FALSE, cv_number = 5, cv_repeats = 4)
  expect_type(test_evaluation_optimization, "double")
...
test_that("mlrMBO optimization of a multi-objective function can be performed is ok", {
  library(mlrMBO)
  library(parallelMap)
  model_evaluation_optimization_decoy = function(x, source_names, algorithm, correct_topology, lr_network_human, signaling_network_human, gr_network_human, settings, secondary_targets = FALSE, remove_direct_links = "no",...){
...
test_that("Data source weights can be estimated from leave-one-in and leave-one-out performances", {
  ...
  weights_settings_loi = prepare_settings_leave_one_in_characterization(lr_network = lr_network_human, sig_network = signaling_network_human, gr_network = gr_network_human, source_weights_df)
  ...
  job_characterization_loi = lapply(weights_settings_loi[1:4], evaluate_model,lr_network = lr_network_human, sig_network = signaling_network_human, gr_network = gr_network_human, settings,calculate_popularity_bias_target_prediction = FALSE, calculate_popularity_bias_ligand_prediction = FALSE, ncitations)
  loi_performances = process_characterization_target_prediction_average(job_characterization_loi)

  # run characterization loo
  weights_settings_loo = prepare_settings_leave_one_out_characterization(lr_network = lr_network_human, sig_network = signaling_network_human, gr_network = gr_network_human, source_weights_df)
  ...
  job_characterization_loo = lapply(weights_settings_loo[1:4], evaluate_model,lr_network = lr_network_human, sig_network = signaling_network_human, gr_network = gr_network_human, settings,calculate_popularity_bias_target_prediction = FALSE, calculate_popularity_bias_ligand_prediction = FALSE,ncitations)
