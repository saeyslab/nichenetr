...
test_that("Evaluate target gene prediction", {
  ...
  performances_target_prediction_medianed = ligands %>% lapply(wrapper_average_performances, performances,"median") %>% bind_rows() %>% drop_na()
  performances_target_prediction_averaged = ligands %>% lapply(wrapper_average_performances, performances,"mean") %>% bind_rows() %>% drop_na()
