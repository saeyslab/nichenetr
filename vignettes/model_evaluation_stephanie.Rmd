...
mat = npyLoad("C:/Users/rbrowaey/work/Research/NicheNet/StephanieChen/new_lt_matrix.npy")
column_names = read.csv("C:/Users/rbrowaey/work/Research/NicheNet/StephanieChen/column_names.txt",sep = ";") %>% colnames()
row_names = read.csv("C:/Users/rbrowaey/work/Research/NicheNet/StephanieChen/row_names.txt",sep = ";") %>% colnames()
colnames(mat) = column_names
rownames(mat) = row_names

mat[1:10,1:20]

ligand_target_matrix = mat %>% t()
...
# settings = settings %>% keep(.$from %in% colnames(ligand_target_matrix))
