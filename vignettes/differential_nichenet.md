...
![](differential_nichenet_files/figure-gfm/unnamed-chunk-65-1.png)<!-- -->
...
![](differential_nichenet_files/figure-gfm/unnamed-chunk-86-1.png)<!-- -->
...
![](differential_nichenet_files/figure-gfm/unnamed-chunk-87-1.png)<!-- -->

From this plot, you can see that some KC-niche ligands like Il34 (by
Stellate cells) are higher expressed in the periportal stellate cells vs
the pericentral ones. This can be interesting information knowing that
KCs are mainly located periportally. However, the fact that other
ligands are not preferentially expressed by periportal cell does not
mean they cannot be interesting.
...
![](differential_nichenet_files/figure-gfm/unnamed-chunk-88-1.png)<!-- -->
...
boxplot) by setting `scaled_ligand_activity_limits = "IQR"`. Any outliers
...
![](differential_nichenet_files/figure-gfm/unnamed-chunk-89-1.png)<!-- -->
In this plot, some strongly DE ligand-receptor pairs in the KC niche,
have also high scaled ligand activity on KCs - making them strong
...
![](differential_nichenet_files/figure-gfm/unnamed-chunk-90-1.png)<!-- -->
...
![](differential_nichenet_files/figure-gfm/unnamed-chunk-91-1.png)<!-- -->![](differential_nichenet_files/figure-gfm/unnamed-chunk-91-2.png)<!-- -->
...
![](differential_nichenet_files/figure-gfm/unnamed-chunk-92-1.png)<!-- -->
...
![](differential_nichenet_files/figure-gfm/unnamed-chunk-93-1.png)<!-- -->
