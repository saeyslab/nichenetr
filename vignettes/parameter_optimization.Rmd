...
rmarkdown::render("vignettes/parameter_optimization.Rmd", output_format = "github_document")
...
```{r weights-between-populations, fig.height=8, fig.width=10}
cv_names <- c("1234", "2345", "1345", "1245", "1235")
...
```{r weights-between-folds, fig.height=8, fig.width=10}
