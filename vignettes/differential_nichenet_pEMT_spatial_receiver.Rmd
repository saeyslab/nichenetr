...
niches = list(
  "pEMT_High_niche" = list(
    "sender" = c("Malignant_High", "Endothelial_High", "myofibroblast_High", "T.cell_High", "Myeloid_High"),
    "receiver" = c("CAF_High")),
  "pEMT_Low_niche" = list(
    "sender" = c("Malignant_low",  "Endothelial_Low", "myofibroblast_Low"),
    "receiver" = c("CAF_Low"))
...
include_spatial_info_receiver = TRUE # if spatial info to include: put this to true # user adaptation required on own dataset
```

```{r}
spatial_info = tibble(celltype_region_oi = "CAF_High", celltype_other_region = "myofibroblast_High", niche =  "pEMT_High_niche", celltype_type = "receiver") # user adaptation required on own dataset
