...
```{r target-prediction-v2-results, fig.width=8, fig.height=8}
...
```{r target-prediction-comparison, fig.width=8, fig.height=6}
...
```{r ligand-activity-v2-results, fig.width=8, fig.height=8}
...
```{r ligand-activity-comparison, fig.width=8, fig.height=6}
