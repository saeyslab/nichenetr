...
First, we will demonstrate how to construct a new ligand-target model
from all ligand-receptor, signaling and gene regulatory network data
...
provided by default by the nichenetr
package).
...
you would have a network or data containing containing context-specific
